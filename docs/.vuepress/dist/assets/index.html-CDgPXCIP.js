import{_ as p,r as t,o as c,c as o,a as n,b as s,w as i,d as a,e as d}from"./app-BdIgI5Dc.js";const r={},u=n("h1",{id:"说下你的vue项目的目录结构-如果是大型项目你该怎么划分结构和划分组件呢",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#说下你的vue项目的目录结构-如果是大型项目你该怎么划分结构和划分组件呢"},[n("span",null,"说下你的vue项目的目录结构，如果是大型项目你该怎么划分结构和划分组件呢？")])],-1),v={class:"table-of-contents"},m=d(`<h2 id="为什么要划分" tabindex="-1"><a class="header-anchor" href="#为什么要划分"><span>为什么要划分</span></a></h2><p>使用vue构建项目，项目结构清晰会提高开发效率，熟悉项目的各种配置同样会让开发效率更高</p><p>在划分项目结构的时候，需要遵循一些基本的原则：</p><ul><li><p>文件夹和文件夹内部文件的语义一致性</p><p>我们的目录结构都会有一个文件夹是按照路由模块来划分的，如pages文件夹，这个文件夹里面应该包含我们项目所有的路由模块，并且仅应该包含路由模块，而不应该有别的其他的非路由模块的文件夹</p><p>这样做的好处在于一眼就从 pages文件夹看出这个项目的路由有哪些</p></li><li><p>单一入口/出口</p><p>举个例子，在pages文件夹里面存在一个seller文件夹，这时候seller 文件夹应该作为一个独立的模块由外部引入，并且 seller/index.js 应该作为外部引入 seller 模块的唯一入口</p><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code><span class="token comment">// 错误用法</span>

<template><div><h1 id="说说-new-操作符具体干了什么" tabindex="-1"><a class="header-anchor" href="#说说-new-操作符具体干了什么"><span>说说 new 操作符具体干了什么？</span></a></h1>
<nav class="table-of-contents"><ul><li><router-link to="#是什么">是什么</router-link></li><li><router-link to="#流程">流程</router-link></li><li><router-link to="#手写-new-操作符">手写 new 操作符</router-link></li></ul></nav>
<h2 id="是什么" tabindex="-1"><a class="header-anchor" href="#是什么"><span>是什么</span></a></h2>
<p>在 JavaScript 中，new 操作符用于创建一个给定构造函数的实例对象</p>
<p>例子</p>
...
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Test</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name
...
<p>从上面介绍中，我们可以看到 new 关键字主要做了以下的工作：</p>
<ul>
<li>
<p>创建一个新的对象 obj</p>
</li>
...
<li>
<p>将构建函数中的 this 绑定到新建的对象 obj 上</p>
</li>
<li>
...
<p><img src="/images/interview/newprocess.png" alt="图片"></p>
<h2 id="手写-new-操作符" tabindex="-1"><a class="header-anchor" href="#手写-new-操作符"><span>手写 new 操作符</span></a></h2>
<p>现在我们已经清楚地掌握了 new 的执行过程</p>
<p>那么我们就动手来实现一下 new</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mynew</span><span class="token punctuation">(</span><span class="token parameter">Func<span class="token punctuation">,</span> <span class="token operator">...</span>args</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以发现，代码虽然很短，但是能够模拟实现new</p>
</div></template>

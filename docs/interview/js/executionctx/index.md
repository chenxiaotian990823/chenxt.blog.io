...
1-16 行的部分为全局上下文，8 和 12 行是不同的函数上下文。只有全局上下文（的变量）能被其他任何上下文访问
...
![图片](/images/interview/excutionStack.png)
...
![图片](/images/interview/excutionStackExample.png)
...
- [https://zhuanlan.zhihu.com/p/107552264](https://zhuanlan.zhihu.com/p/107552264)